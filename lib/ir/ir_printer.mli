val to_dot : Node2.G.readonly Node2.G.t -> string
...
val to_string_linear : Node2.G.readonly Node2.G.t -> string
...
val pp_dot : Format.formatter -> Node2.G.readonly Node2.G.t -> unit
